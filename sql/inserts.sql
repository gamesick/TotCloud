...
-- 2. PERSONAL
INSERT INTO PERSONAL (idPersonal, nombrePersonal) VALUES
(4, 'David Miller'),
(5, 'Eve Adams'),
(6, 'Franklin Richards');

-- 3. USUARIO
INSERT INTO USUARIO (idUsuario, nombreUsuario, idOrganizacion) VALUES
(4, 'david.miller', 4),
(5, 'eve.adams', 5),
(6, 'frank.richards', 6);
...
(5, 'HR', 'Human Resources group', 5),
(6, 'IT Support', 'Group for IT support staff', 6);
...
(5, 'MANAGE_USERS', 'Privilege to manage user accounts', 5),
(6, 'VIEW_ANALYTICS', 'Privilege to view analytics data', 6);

-- 6. ETAPA
INSERT INTO ETAPA (idEtapa, nombreEtapa, estado, idPersonal) VALUES
(4, 'Integraci贸n', 'en_proceso', 4),
(5, 'Testing', 'completada', 5),
(6, 'Deploy', 'en_proceso', 6);
...
-- 8. PERSONA
INSERT INTO PERSONA (idPersona, nombre, apellido, email, idGrupo) VALUES
(4, 'Laura', 'King', 'laura.king@example.com', 4),
(5, 'Mike', 'Brown', 'mike.brown@example.com', 5),
(6, 'Sophie', 'Green', 'sophie.green@example.com', 6);
