        ...
        <div class="sections">
            ...
            <div class="section-card">
                <?php if ($action === 'editarVC' && isset($_GET['idVCConfig']) && !empty($vcToEdit) && $_SERVER['REQUEST_METHOD'] !== 'POST'): ?>
                    ...
                    <form action="saasPro.php?action=editarVC&idVCConfig=<?php echo (int)$_GET['idVCConfig']; ?>" method="POST">
                        ...
                        <input type="number" name="anchoBanda" min="1" max="100" value="<?php echo (int)$vcToEdit['anchoBanda']; ?>" required>

                        <label>Número máximo de Participantes:</label>
                        <input type="number" name="maxParticipantes" min="1" max="50" value="<?php echo (int)$vcToEdit['maxParticipantes']; ?>" required>
                ...
                <?php else: ?>
                    ...
                    <form action="saasPro.php?action=crearVC" method="POST">
                        ...
                        <input type="number" id="anchoBanda" name="anchoBanda" min="1" max="100" required>

                        <label for="maxParticipantes">Número máximo de Participantes:</label>
                        <input type="number" id="maxParticipantes" name="maxParticipantes" min="1" max="50" required>
                        ...
                        <?php if (!empty($vcList)): ?>
                            <?php foreach ($vcList as $vcItem): ?>
                                ...
                                <td><?php echo htmlspecialchars($vcItem['nombreVC']); ?></td>
                                    <td class="actions">
                                        <a href="saasPro.php?action=editarVC&idVCConfig=<?php echo (int)$vcItem['idVCConfig']; ?>">Editar</a>
                                        <a href="saasPro.php?action=eliminarVC&idVCConfig=<?php echo (int)$vcItem['idVCConfig']; ?>">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
